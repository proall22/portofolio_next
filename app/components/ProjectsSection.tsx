...
const projects = [
  ...
  },
  {
    ...
    demoUrl: "https://example.com/security-tool-demo",
    githubUrl: "https://github.com/example/security-audit-tool",
  },
]
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {filteredProjects.map((project, index) => (
            ...
            >
              <div className="p-6">
                <div className="flex items-center mb-4">
                  {project.category === "fullstack" && (
                    <Code className={`w-8 h-8 mr-4 ${theme === "dark" ? "text-teal-400" : "text-blue-500"}`} />
                  )}
                  {project.category === "frontend" && (
                    <Palette className={`w-8 h-8 mr-4 ${theme === "dark" ? "text-teal-400" : "text-pink-500"}`} />
                  )}
                  {project.category === "security" && (
                    <Shield className={`w-8 h-8 mr-4 ${theme === "dark" ? "text-teal-400" : "text-green-500"}`} />
                  )}
                  <h3 className={`text-xl font-semibold ${theme === "dark" ? "" : "text-sky-600"}`}>{project.title}</h3>
                </div>
              ...
              <div className={theme === "dark" ? "bg-gray-700 p-6" : "bg-white bg-opacity-50 p-6"}>
                <h4 className={`text-lg font-semibold mb-2 ${theme === "dark" ? "" : "text-sky-600"}`}>Preview</h4>
                <div
                  className={`aspect-w-16 aspect-h-9 rounded-lg flex items-center justify-center ${
                    theme === "dark" ? "bg-gray-600" : "bg-gray-200"
                  }`}
                >
                  <div className={theme === "dark" ? "text-gray-400" : "text-gray-500"}>Project Preview</div>
                </div>
              </div>
            </motion.div>
          ))}
              ...
              <div className="relative p-6">
                ...
                <div className="flex items-center mb-6">
                  {selectedProject.category === "fullstack" && (
                    <Code className={`w-10 h-10 mr-4 ${theme === "dark" ? "text-teal-400" : "text-blue-500"}`} />
                  )}
                  {selectedProject.category === "frontend" && (
                    <Palette className={`w-10 h-10 mr-4 ${theme === "dark" ? "text-teal-400" : "text-pink-500"}`} />
                  )}
                  {selectedProject.category === "security" && (
                    <Shield className={`w-10 h-10 mr-4 ${theme === "dark" ? "text-teal-400" : "text-green-500"}`} />
                  )}
                  <h3 className={`text-2xl font-bold ${theme === "dark" ? "" : "text-sky-600"}`}>
                ...
                <div className="mb-6">
                  <h4 className={`text-xl font-semibold mb-2 ${theme === "dark" ? "" : "text-sky-600"}`}>
                    Description
                  </h4>
                    ...
                    {selectedProject.technologies.map((tech) => (
                      <span
                        ...
                        className={`px-3 py-1 rounded-full text-sm ${
                          theme === "dark" ? "bg-gray-700" : "bg-white bg-opacity-70 text-gray-700 shadow-sm"
                        }`}
                      >
                        {tech}
                      </span>
                ...
                <div className="flex flex-wrap gap-4">
                  ...
                  <a
                    ...
                    rel="noopener noreferrer"
                    className={`flex items-center gap-2 px-4 py-2 rounded-full ${
                      theme === "dark" ? "bg-gray-700" : "bg-white text-gray-700 shadow-sm"
                    }`}
                  >
                ...
                >
                  <p className="text-sm">Swipe left or right to view more projects</p>
                </div>
              </div>
            </motion.div>
          </motion.div>
